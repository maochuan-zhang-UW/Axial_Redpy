...
# Top 10 by size
top10 = sorted(enumerate(families), key=lambda x: -len(x[1]))[:10]
...
legend_handles = []
for rank, (fam_idx, members) in enumerate(top10):
...
ax.set_title('Top 10 Repeating Earthquake Family Locations\nAxial Seamount — Mar 2015',
             fontsize=13)
...
outfile = './runs/axial/top10_locations.png'
